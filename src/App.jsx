  ...
  return (
    <div style={{ padding: 20 }}>
      <div style={{ textAlign: "center", marginBottom: 16 }}>
        <h1 style={{ marginBottom: 4, fontSize: 28 }}>Lago De Oro Inventory System</h1>
        <p style={{ marginTop: 0, color: "#555", fontSize: 14 }}>Manage stock IN / OUT and reports</p>
      </div>

      {/* FULL JSX CONTENT CONTINUES EXACTLY AS PROVIDED */}
    </div>
  );
}
