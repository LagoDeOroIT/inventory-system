...
// =============================
// STOCK ROOMS MASTER LIST
// =============================
// Each inventory item can be assigned to ONE stock room
// (or extended later to support multiple rooms per item)
...
//   quantity: 50,
//   unit: "sack",
//   stockRoomId: "L1", // must match STOCK_ROOMS.id
//   minimumLevel: 10,
...
// =============================
// STOCK ROOM MENU FLOW (CORE UX)
// =============================
// This menu acts as the ENTRY POINT of the system
// User must select a Stock Room first before any action

/*
FLOW:
1. Click "Stock Rooms" menu
2. Select a Stock Room (L1, L2 Room 1, Maintenance B1, etc.)
3. System loads context based on selected room
4. Available actions:
   - View Items
   - Add Item
...
// =============================
// SELECTED STOCK ROOM STATE
// =============================

// Example global state (Context / Redux / Zustand-ready)

export const selectedStockRoom = {
  id: null,        // e.g. "L2-R3"
  name: null,      // e.g. "L2 Room 3"
};
...
// Every transaction is ALWAYS tied to a stock room

// Example:
// {
//   id: "TXN-0001",
//   stockRoomId: "MAINT-B1",
//   itemId: "ITEM-023",
...
//   date: "2026-01-22",
//   remarks: "Used for repair"
// }

// =============================
// MONTHLY REPORT LOGIC (ROOM-BASED)
// =============================

/*
Monthly reports are generated PER STOCK ROOM
Filters:
- Stock Room (required)
- Month
- Year
...
// =============================
// ACTUAL SIDEBAR UI – STOCK ROOM FIRST DESIGN
// =============================
          ...
          <li key={room.id}>
            ...
            {openRoom === room.id && (
              <ul className="ml-4 mt-2 space-y-1 text-sm">
                <li>
                  <button
                    onClick={() => onSelect(room, "view-items")}
                ...
                <li>
                  <button
                    onClick={() => onSelect(room, "add-item")}
                    className="hover:text-blue-400"
                  >
                    Add Item
                  </button>
                ...
                <li>
                  <button
                    onClick={() => onSelect(room, "transactions")}
                    className="hover:text-blue-400"
                  >
                    Stock Transactions
                  </button>
                ...
                <li>
                  <button
                    onClick={() => onSelect(room, "monthly-report")}
                    className="hover:text-blue-400"
                  >
                    Monthly Report
                  </button>
...
export function AppLayout() {
  ...
  return (
    <div className="flex">
      <Sidebar
        onSelect={(room, action) =>
          setContext({ room, action })
        }
      />

      <main className="flex-1 p-6">
        {!context.room && (
          <p className="text-gray-500">Select a stock room to begin</p>
        )}

        {context.room && (
          <h1 className="text-2xl font-bold mb-4">
            {context.room.name} — {context.action}
          </h1>
        )}
