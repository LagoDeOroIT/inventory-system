    ...
    >
      ...
      <div style={{ flex: 1, overflowY: "auto", marginTop: 10 }}>
        ...
        >
          ...
          <tbody>
            {(() => {
              const filteredDeleted = deletedItemsSorted.filter(
                (item) =>
                  (item.item_name || "")
                    .toLowerCase()
              ...
              return filteredDeleted.map((i) => (
                <tr key={i.id}>
                  <td style={tdStyle}>{capitalizeWords(i.item_name)}</td>
                  <td style={tdStyle}>{capitalizeWords(i.brand)}</td>
                  <td style={tdStyle}>
                    ₱
                  ...
                  <td style={{ ...tdStyle, textAlign: "center" }}>
                    <div
                      className="action-menu"
                      ref={(el) =>
                        (menuRefs.current["delitem-" + i.id] = el)
                      }
                    >
                      <button
                        onClick={(e) => {
    ...
    >
      ...
      <div style={{ flex: 1, overflowY: "auto", marginTop: 10 }}>
        ...
        >
          ...
          <tbody>
            {(() => {
              const filteredDeletedTx = deletedTransactionsSorted.filter(
                (t) =>
                  (t.items?.item_name || "")
                    .toLowerCase()
              ...
              return filteredDeletedTx.map((i) => (
                <tr key={i.id}>
                  ...
                  <td style={tdStyle}>
                    ...
                    {Number(
                      i.quantity *
                        (i.unit_price || i.items?.unit_price || 0)
                  ...
                  <td style={{ ...tdStyle, textAlign: "center" }}>
                    <div
                      className="action-menu"
                      ref={(el) =>
                        (menuRefs.current["deltx-" + i.id] = el)
                      }
                    >
                      <button
                        onClick={(e) => {
